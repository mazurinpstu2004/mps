...
Лабораторная работа №2. Вероятностные автоматы. Программа описывает поведение электрического чайника методом конечных автоматов.
...
Лабораторная работа №3. Генератор случайных чисел. Программа реализует генератор случайных чисел при помощи линейного конгруэнтного метода.

Для генерации чисел были подобраны следующие параметры:

  Модуль M = 2^32;
  Множитель k = 472308099;
  Приращение b = 0;
  Начальное значение r = 1.
